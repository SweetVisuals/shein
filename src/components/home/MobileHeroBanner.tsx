...
export const MobileHeroBanner = () => {
  return (
    <div className="w-full relative cursor-pointer text-center text-white flex flex-col items-center justify-center pt-2 pb-6 px-4" style={{
      backgroundImage: 'linear-gradient(to right, #ba163b, #d92443, #c5183a)'
         ...
         <div className="z-10 flex text-[#FFD700] items-baseline drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)] mt-[-4px]">
           ...
           <span className="text-3xl leading-none font-bold ml-1">OFF</span>
         </div>
